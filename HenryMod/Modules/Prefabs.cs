...
namespace Autimecia.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = AutimeciaPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = AutimeciaPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = AutimeciaPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = AutimeciaPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            AutimeciaPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            AutimeciaPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            AutimeciaPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
