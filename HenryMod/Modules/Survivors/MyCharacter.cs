...
namespace Autimecia.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(AutimeciaPlugin.developerPrefix + "_HENRY_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(AutimeciaPlugin.developerPrefix + "_HENRY_BODY_MASTERY_SKIN_NAME",
